...
{    
    ...
    {
        DrawDebugLine(GetWorld(), Points[i].Location, Points[i + 1].Location, FColor::Cyan, false, 0.1f, 0, 20.f);
        DrawDebugSphere(GetWorld(), Points[i].Location, 20.f, 32, FColor::Cyan, false, 0.1f, 0, 1.f);
    }
    DrawDebugSphere(GetWorld(), Points.Last(), 20.f, 32, FColor::Cyan, false, 0.1f, 0, 1.f);
}
